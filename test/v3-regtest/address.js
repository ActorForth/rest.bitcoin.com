...
describe("#AddressRouter", () => {
  ...
  describe("#AddressDetailsBulk", () => {
    ...
    it("should detect a network mismatch", async () => {
      req.body = {
        addresses: [`bchreg:qren0vw0ru8l5v39ne6ru3dlg630w7s3u5rjk5lhra`]
      }
    ...
    it("should throw 500 when network issues", async () => {
      ...
      try {
        req.body = {
          addresses: [`bchreg:qzv4gdq2ghntw2us27pxmsv9csw33xymtshcga9zr6`]
        }
    ...
    it("should default to page 0", async () => {
      ...
      if (process.env.TEST === "unit") {
        nock(`${process.env.BITCOINCOM_BASEURL}`)
          .get(`/addr/qzv4gdq2ghntw2us27pxmsv9csw33xymtshcga9zr6?from=0&to=1000`)
    ...
    it("should process the requested page", async () => {
      ...
      if (process.env.TEST === "unit") {
        nock(`${process.env.BITCOINCOM_BASEURL}`)
          .get(`/addr/qzv4gdq2ghntw2us27pxmsv9csw33xymtshcga9zr6?from=5000&to=6000`)
          .reply(200, mockData.mockAddressDetails)
      }
    ...
    it("should get details for multiple addresses", async () => {
      req.body = {
        addresses: [
          `bchreg:qzv4gdq2ghntw2us27pxmsv9csw33xymtshcga9zr6`,
          `bchreg:qzeyugjut4yjzul24pdtx53ffqdc05luz5yml0yuzq`
        ]
      }
  ...
  describe("#AddressDetailsSingle", () => {
    ...
    it("should detect a network mismatch", async () => {
      req.params.address = `bchreg:qren0vw0ru8l5v39ne6ru3dlg630w7s3u5rjk5lhra`
    ...
    it("should default to page 0", async () => {
      req.params.address = `bchreg:qzv4gdq2ghntw2us27pxmsv9csw33xymtshcga9zr6`
  ...
  describe("#AddressUtxoBulk", () => {
    ...
    it("should get utxos for a single address", async () => {
      ...
      if (process.env.TEST === "unit") {
        nock(`${process.env.BITCOINCOM_BASEURL}`)
          .get(`/addr/qzv4gdq2ghntw2us27pxmsv9csw33xymtshcga9zr6/utxo`)
  ...
  describe("#AddressUnconfirmedBulk", () => {
    ...
    it("should error on non-array single address", async () => {
      req.body = {
        address: `bchreg:qzv4gdq2ghntw2us27pxmsv9csw33xymtshcga9zr6`
      }
  ...
  describe("#AddressTransactionsBulk", () => {
    ...
    it("should default to page 0", async () => {
      ...
      if (process.env.TEST === "unit") {
        nock(`${process.env.BITCOINCOM_BASEURL}`)
          .get(
            `/txs/?address=bchreg:qzv4gdq2ghntw2us27pxmsv9csw33xymtshcga9zr6&pageNum=0`
          )
    ...
    it("should process the requested page", async () => {
      ...
      if (process.env.TEST === "unit") {
        nock(`${process.env.BITCOINCOM_BASEURL}`)
          .get(
            `/txs/?address=bchreg:qzv4gdq2ghntw2us27pxmsv9csw33xymtshcga9zr6&pageNum=5`
          )
          .reply(200, mockData.mockTransactions)
      }
    ...
    it("should get transactions for an array of addresses", async () => {
      ...
      if (process.env.TEST === "unit") {
        ...
        nock(`${process.env.BITCOINCOM_BASEURL}`)
          .get(
            `/txs/?address=bchreg:qzeyugjut4yjzul24pdtx53ffqdc05luz5yml0yuzq&pageNum=0`
          )
          .reply(200, mockData.mockTransactions)
      }
  ...
  describe("#AddressFromXPubSingle", () => {
    ...
    it("should create an address from xpub", async () => {
      ...
      assert.exists(result.legacyAddress)
      assert.exists(result.cashAddress)
      assert.isTrue(result.cashAddress.includes("bchreg:"))
