...
describe("#Util", () => {
  ...
  describe("#validateAddressSingle", async () => {
    ...
    it("should throw 503 when network issues in util 1", async () => {
  ...
  describe("#validateAddressBulk", async () => {
    ...
    it("should error on invalid address", async () => {
      req.body = {
        addresses: [`bchreg:000sw0rhqlm3uxff0009d7w97mh5f5r58cw65ymzum`]
      }
    ...
    it("should throw 503 when network issues in util 2", async () => {
      // Save the existing RPC URL.
      const savedUrl2 = process.env.RPC_BASEURL
