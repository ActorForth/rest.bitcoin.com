...
describe("#AddressRouter", () => {
  ...
  describe("#AddressDetailsBulk", () => {
    ...
    it("should detect a network mismatch 1", async () => {
      req.body = {
        addresses: [`bchreg:qqusw0rhqlm3uxffdcp9d7w97mh5f5r58cw65ymzum`]
      }
    ...
    it("should default to page 0", async () => {
      console.log(">>>>>>>>>>>>>>>should get utxos for a single address 1")
      ...
      if (process.env.TEST === "unit") {
        nock(`${process.env.BITCOINCOM_BASEURL}`)
          .get(`/addr/mkiVUmUvhkLStUjpy4JXc1BPS91wqKTSyu?from=0&to=1000`)
    ...
    it("should process the requested page", async () => {
      ...
      if (process.env.TEST === "unit") {
        nock(`${process.env.BITCOINCOM_BASEURL}`)
          .get(`/addr/mkiVUmUvhkLStUjpy4JXc1BPS91wqKTSyu?from=5000&to=6000`)
          .reply(200, mockData.mockAddressDetails)
      }
    ...
    it("should get details for a single address", async () => {
      console.log(">>>>>>>>>>>>>>>should get utxos for a single address 2")
    ...
    it("should get details for multiple addresses", async () => {
      req.body = {
        addresses: [
          `bchreg:qqusw0rhqlm3uxffdcp9d7w97mh5f5r58cw65ymzum`,
          `bchreg:qpvcxgezthtaksnklt4u055act36h6k36chhx8x56l`
        ]
      }
      ...
      if (process.env.TEST === "unit") {
        ...
        nock(`${process.env.BITCOINCOM_BASEURL}`)
          .get(`/addr/mogFXhgrSM3RzZa27W9fL5PJbBuCMSevaw?from=0&to=1000`)
          .reply(200, mockData.mockAddressDetails)
      }
  ...
  describe("#AddressDetailsSingle", () => {
    ...
    it("should detect a network mismatch 2", async () => {
      req.params.address = `bchreg:qqusw0rhqlm3uxffdcp9d7w97mh5f5r58cw65ymzum`
    ...
    it("should default to page 0", async () => {
      console.log(">>>>>>>>>>>>>>>should get utxos for a single address 3")
    ...
    it("should get details for a single address", async () => {
      console.log(">>>>>>>>>>>>>>>should get utxos for a single address 4")
  ...
  describe("#AddressUtxoBulk", () => {
    ...
    it("should detect a network mismatch 3", async () => {
      req.body = {
        addresses: [`bchreg:qqusw0rhqlm3uxffdcp9d7w97mh5f5r58cw65ymzum`]
      }
    ...
    it("should throw 500 when network issues", async () => {
      console.log("should throw 500 when network issues")
      const savedUrl = process.env.BITCOINCOM_BASEURL
    ...
    it("should get utxos for a single address", async () => {
      console.log(">>>>>>>>>>>>>>>should get utxos for a single address 5")
      ...
      if (process.env.TEST === "unit") {
        nock(`${process.env.BITCOINCOM_BASEURL}`)
          .get(`/addr/mkiVUmUvhkLStUjpy4JXc1BPS91wqKTSyu/utxo`)
    ...
    it("should get utxos for mulitple addresses", async () => {
      ...
      if (process.env.TEST === "unit") {
        ...
        nock(`${process.env.BITCOINCOM_BASEURL}`)
          .get(`/addr/mogFXhgrSM3RzZa27W9fL5PJbBuCMSevaw/utxo`)
          .reply(200, mockData.mockUtxoDetails)
      }
  ...
  describe("#AddressUtxoSingle", () => {
    ...
    it("should detect a network mismatch 4", async () => {
      req.params.address = `bchreg:qqusw0rhqlm3uxffdcp9d7w97mh5f5r58cw65ymzum`
    ...
    it("should get details for a single address", async () => {
      console.log(">>>>>>>>>>>>>>>should get utxos for a single address 6")
  ...
  describe("#AddressUnconfirmedBulk", () => {
    ...
    it("should error on non-array single address", async () => {
      req.body = {
        address: `bchreg:qqusw0rhqlm3uxffdcp9d7w97mh5f5r58cw65ymzum`
      }
    ...
    it("should detect a network mismatch 5", async () => {
      req.body = {
        addresses: [`bchreg:qqusw0rhqlm3uxffdcp9d7w97mh5f5r58cw65ymzum`]
      }
  ...
  describe("#AddressUnconfirmedSingle", () => {
    ...
    it("should detect a network mismatch 6", async () => {
      req.params.address = `bchreg:qqusw0rhqlm3uxffdcp9d7w97mh5f5r58cw65ymzum`
    ...
    it("should get details for a single address", async () => {
    console.log(">>>>>>>>>>>>>>>should get utxos for a single address 7")
  ...
  describe("#AddressTransactionsBulk", () => {
    ...
    it("should detect a network mismatch 7", async () => {
      req.body = {
        addresses: [`bchreg:qqusw0rhqlm3uxffdcp9d7w97mh5f5r58cw65ymzum`]
      }
    ...
    it("should default to page 0", async () => {
      console.log(">>>>>>>>>>>>>>>should get utxos for a single address 8")
      ...
      if (process.env.TEST === "unit") {
        nock(`${process.env.BITCOINCOM_BASEURL}`)
          .get(
            `/txs/?address=bchreg:qqusw0rhqlm3uxffdcp9d7w97mh5f5r58cw65ymzum&pageNum=0`
          )
    ...
    it("should process the requested page", async () => {
      ...
      if (process.env.TEST === "unit") {
        nock(`${process.env.BITCOINCOM_BASEURL}`)
          .get(
            `/txs/?address=bchreg:qqusw0rhqlm3uxffdcp9d7w97mh5f5r58cw65ymzum&pageNum=5`
          )
          .reply(200, mockData.mockTransactions)
      }
    ...
    it("should get transactions for an array of addresses", async () => {
      ...
      if (process.env.TEST === "unit") {
        ...
        nock(`${process.env.BITCOINCOM_BASEURL}`)
          .get(
            `/txs/?address=bchreg:qpvcxgezthtaksnklt4u055act36h6k36chhx8x56l&pageNum=0`
          )
          .reply(200, mockData.mockTransactions)
      }
  ...
  describe("#AddressTransactionsSingle", () => {
    ...
    it("should detect a network mismatch 8", async () => {
      req.params.address = `bchreg:qqusw0rhqlm3uxffdcp9d7w97mh5f5r58cw65ymzum`
    ...
    it("should default to page 0", async () => {
      console.log(">>>>>>>>>>>>>>>should get utxos for a single address 9")
      req.params.address = `bchreg:qqusw0rhqlm3uxffdcp9d7w97mh5f5r58cw65ymzum`
    ...
    it("should get details for a single address", async () => {
      console.log(">>>>>>>>>>>>>>>should get utxos for a single address 10")
