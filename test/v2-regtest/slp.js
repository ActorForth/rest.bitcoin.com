...
describe("#SLP", () => {
  ...
  describe("#listSingleToken()", () => {
    ...
    it("should get token information in slp 1", async () => {
      // testnet
      const tokenIdToTest =
        "650dea14c77f4d749608e36e375450c9ac91deb8b1b53e50cb0de2059a52d19a"
  ...
  describe("balancesForAddressSingle()", () => {
    ...
    it("should throw 5XX error when network issues 1", async () => {
      ...
      req.params.address = "slpreg:qz35h5mfa8w2pqma2jq06lp7dnv5fxkp2shlcycvd5"
  ...
  describe("#balancesForAddressBulk", () => {
    ...
    it("should throw 5XX error when network issues 2", async () => {
      // Save the existing SLPDB_URL.
      const savedUrl2 = process.env.SLPDB_URL
  ...
  describe("balancesForAddressByTokenIDSingle()", () => {
    ...
    it("should throw 5XX error when network issues 3", async () => {
    ...
    it("should get token information in slp 2", async () => {
      if (process.env.TEST === "unit") {
        nock(mockServerUrl)
          .get(uri => uri.includes("/"))
          .times(2)
