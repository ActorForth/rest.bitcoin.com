...
describe("#BlockchainRouter", () => {
  ...
  describe("getBestBlockHash()", () => {
    ...
    it("should throw 503 when network issues in blockchain 1", async () => {
  ...
  describe("getBlockchainInfo()", () => {
    ...
    it("should throw 503 when network issues in blockchain 2", async () => {
      // Save the existing RPC URL.
      const savedUrl2 = process.env.RPC_BASEURL
  ...
  describe("getBlockCount()", () => {
    ...
    it("should throw 503 when network issues in blockchain 3", async () => {
      // Save the existing RPC URL.
      const savedUrl2 = process.env.RPC_BASEURL
  ...
  describe("getBlockHeaderSingle()", async () => {
    ...
    it("should throw 503 when network issues in blockchain 4", async () => {
      // Save the existing RPC URL.
      const savedUrl2 = process.env.RPC_BASEURL
  ...
  describe("getChainTips()", () => {
    ...
    it("should throw 503 when network issues in blockchain 5", async () => {
      // Save the existing RPC URL.
      const savedUrl2 = process.env.RPC_BASEURL
  ...
  describe("getDifficulty()", () => {
    ...
    it("should throw 503 when network issues in blockchain 6", async () => {
      // Save the existing RPC URL.
      const savedUrl2 = process.env.RPC_BASEURL
  ...
  describe("getMempoolInfo()", () => {
    ...
    it("should throw 503 when network issues in blockchain 7", async () => {
      // Save the existing RPC URL.
      const savedUrl2 = process.env.RPC_BASEURL
  ...
  describe("getRawMempool()", () => {
    ...
    it("should throw 503 when network issues in blockchain 8", async () => {
      // Save the existing RPC URL.
      const savedUrl2 = process.env.RPC_BASEURL
  ...
  describe("getMempoolEntry()", () => {
    ...
    it("should throw 503 when network issues in blockchain 9", async () => {
      // Save the existing RPC URL.
      const savedUrl2 = process.env.RPC_BASEURL
  ...
  describe("getTxOut()", () => {
    ...
    it("should throw 503 when network issues in blockchain 10", async () => {
      // Save the existing RPC URL.
      const savedUrl2 = process.env.RPC_BASEURL
  ...
  describe("getTxOutProof()", () => {
    ...
    it("should throw 503 when network issues in blockchain 11", async () => {
      // Save the existing RPC URL.
      const savedUrl2 = process.env.RPC_BASEURL
  ...
  describe("verifyTxOutProof()", () => {
    ...
    it("should throw 503 when network issues in blockchain 12", async () => {
      // Save the existing RPC URL.
      const savedUrl2 = process.env.RPC_BASEURL
